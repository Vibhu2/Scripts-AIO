...
#Get-MsolUser -TenantID 64bbd6bc-29f9-4fa4-8c83-589fcfe87718 -MaxResults 100 | Format-Table -Property * -AutoSize -wrap | Out-String -Width 9096 `
#| Out-File C:\itconnexx-a\report.txt

Get-MsolUser -TenantID 64bbd6bc-29f9-4fa4-8c83-589fcfe87718 -all | Select-Object -Property DisplayName,Department,UserPrincipalName,IsLicensed,LastPasswordChangeTimestamp,WhenCreated | Format-Table -AutoSize | Out-File C:\itconnexx-a\report.txt
